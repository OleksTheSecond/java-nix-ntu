...
public class DemoReport {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        Report report1 = new Report( "Title#1", 2L);
        Report report2 = new Report( "Title#2", 1L);
        Report report3 = new Report("Title#3", 1L);
        ...
        //Updaet second
        Report toUpdate = new Report( "Title#UPDATED", 2L);
