...
public abstract class AbstractDao<E> {
  ...
  //  protected abstract List<E> findAllWithSpecifiedId(Session session);
...
//    public List<E> findAllWithSpecifiedId() throws Exception {
//        Session session = openSession();
//        return findAllWithSpecifiedId(session);
//    }
